...
const imgname1 = ['qrcode','qrcode','qrcode','qrcode','qrcode','qrcode','qrcode'];
const tit2 = ['居家维修保养','出行接送','我的受赠人','我的住宿优惠','我的活动','我的发布'];
const imgname2 = ['qrcode','qrcode','qrcode','qrcode','qrcode','qrcode'];
    ...
    render() {       
        return (      
            <ScrollView>              
                ...
                onPress={this.goout}>
                <Text style={{color:'white',fontSize:20}}>退 出 登 录</Text>
