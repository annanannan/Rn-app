      ...
      <View style={{flex: 1,marginTop:50}}>
        <View
          ...
          <View
            ...
            <TextInput style={{fontSize:20}} placeholder="用户名" 
          ...
          <View
            ...
            <TouchableOpacity 
                ...
                <Text style={{color:'white',fontSize:20}}>注 册</Text>
            </TouchableOpacity>
        </View>
        {
        ...
        }
        {
          ...
          ?<View style={{marginTop:100,fontSize:50}}>
            <ActivityIndicator text="正  在  登  录" />
          </View>
          :null
        }
      </View>
